# -*- coding: utf-8 -*-
# https://colab.research.google.com/drive/1XRScbJVy6yyugxfWKH1fcdi6FmtwvVzC?usp=sharing#scrollTo=z9zRTkUBsCof : 참조 url

# 221.151.83.139:31222 서버에서 환경으로 컴파일 및 개발환경 conda로 설정
# conda env list
# conda activate nettars_env
